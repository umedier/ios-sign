<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"themes/simpleboot3/user/login.html";i:1588177438;s:35:"themes/simpleboot3/public/head.html";i:1577937062;s:37:"themes/simpleboot3/public/footer.html";i:1577937062;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>闪签</title>
...
<style>
    .login-box{width:1050px;height:500px;background:rgba(255,255,255,1);box-shadow:0px 3px 7px 0px rgba(0, 0, 0, 0.35);overflow: hidden; margin: 0 auto;transform: translate(0,40%);}
    ...
    .login-box-bottom-right{width: 450px;float: right;margin-right: 29px;}
    .login-box-bottom-right .user-login{font-weight: bold;}
    .form-group input{width: 100%;background: #fff;border: 0;outline:none;height: 50px;margin-top: 10px;box-sizing: border-box}
    .captcha-f{height: 60px;border-bottom: solid 1px #DBDBDB;margin-bottom: 10px;}
    .captcha-f input{margin-top: 10px;width: 249px;height: 49px;background: #fff;border: 0;outline:none;padding: 0 5px;}
    .captcha-f img{margin-top: 15px;}
...
<img src="<?php echo $__CAPTCHA_SRC; ?>" onclick="this.src='<?php echo $__CAPTCHA_SRC; ?>&time='+Math.random();" title="换一张" class="captcha captcha-img verify_img" style="cursor: pointer;"/>
            		...
            		<div class="form-group">
                        <div class="register-left">
                            <a href="/user/register/index.html">免费注册</a>
                        </div>
                        <div class="findpassword-right">
                            <a href="/user/login/findpassword.html">忘记密码 ？</a>
                        </div>
                    </div>
