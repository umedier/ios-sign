<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"themes/admin_simpleboot3/admin/certificate/index.html";i:1577937062;s:43:"themes/admin_simpleboot3/public/header.html";i:1577937062;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <table class="table table-hover table-bordered margin-top-20">
        ...
        <tbody>
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): if($vo['limit_count'] == 0): ?>
        		<tr class="over">
        	<?php else: ?>
        		<tr class="">
        	<?php endif; ?>
                ...
                <?php if($vo['limit_count'] > 0): ?>
                	<td style="color:#0d56ff;font-weight:bold;"><?php echo $vo['limit_count']; ?></td>
                <?php else: ?>
                ...
                <td class="link">
                	<?php if($vo['status'] == 1 || $vo['status'] == 0): ?>
					...
					<a href='javascript:void(0)' onclick="getUdid(<?php echo $vo["id"]; ?>)">UDID</a>
...
<script>
	function getUdid(cid){
		layer.open({
		  ...
		  title:'UDID',
		  shade: 0,
		  content: "<?php echo url('admin/certificate/udid'); ?>?cid="+cid
		});
	}
</script>
