<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"themes/admin_simpleboot3/admin/download/supindex.html";i:1577937062;s:43:"themes/admin_simpleboot3/public/header.html";i:1577937062;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active tabs_index tabs_li"><a href="javascript:;">下载数列表</a></li>
        <li class="tabs_li tabs_add"><a href="javascript:void(0)" onclick="sup_add()">添加超级签名下载</a></li>
    </ul>
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($download) || $download instanceof \think\Collection || $download instanceof \think\Paginator): if( count($download)==0 ) : echo "" ;else: foreach($download as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0)" onclick="sup_edit(<?php echo $vo['id']; ?>)">编 辑</a> |
...
<script>
	function sup_edit(id){
		...
		layer.open({
		  ...
		  fixed: false, //不固定
		  maxmin: true,
		  title:'修改超级签名下载  ID:'+id,
		  content: "<?php echo url('download/add_sup'); ?>?id="+id,
		  end:function(){
	...
	function sup_add(){
		...
		layer.open({
		  ...
		  maxmin: true,
		  title:'添加超级签名下载',
		  content: "<?php echo url('download/add_sup'); ?>",
		  end:function(){
			  $('.tabs_li').removeClass('active');
