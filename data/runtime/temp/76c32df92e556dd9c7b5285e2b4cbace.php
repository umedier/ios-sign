<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"themes/admin_simpleboot3/admin/certificate/add_certificate.html";i:1577937062;s:43:"themes/admin_simpleboot3/public/header.html";i:1577937062;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <div class="wrap js-check-wrap" style="height:400px">
        <form class="form-horizontal js-ajax-form" action="<?php echo url('certificate/save_certificate'); ?>" method="post"
            ...
            <button type="submit" class="btn btn-default js-ajax-submit">保存</button>
        </form>
    </div>
