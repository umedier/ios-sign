<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"themes/simpleboot3/user/profile/edit.html";i:1588176603;s:35:"themes/simpleboot3/public/head.html";i:1577937062;s:35:"themes/simpleboot3/public/tube.html";i:1588176406;s:37:"themes/simpleboot3/public/footer.html";i:1577937062;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>闪签</title>
                ...
                <form class="js-ajax-form" action="<?php echo url('user/profile/editPost'); ?>" method="post">
                    <div class="sq-form-item">
                        ...
                        <div class="item-input">
                            <input name="user_email" type="text" placeholder="请输入邮箱" value="<?php echo $user['user_email']; ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="sq-form-item">
                        ...
                        <div class="item-input">
                            <input name="user_nickname" type="text" value="<?php echo $user['user_nickname']; ?>" placeholder="请输入用户昵称" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="sq-form-item">
                        ...
                        <div class="item-input">
                            <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=177777321&amp;site=qq&amp;menu=yes" style="color:#348ef1 ">点击查看</a>
                        </div>
                    </div>
                    <div class="sq-form-item">
