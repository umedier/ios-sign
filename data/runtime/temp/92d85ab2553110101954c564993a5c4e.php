<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"themes/admin_simpleboot3/admin/index/index.html";i:1577937062;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title><?php echo $site_name; ?> <?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand"
               style="min-width: 200px;text-align: center;"><?php echo $site_name; ?></a>
