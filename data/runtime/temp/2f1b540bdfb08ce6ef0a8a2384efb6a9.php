<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"themes/simpleboot3/portal/index.html";i:1588176105;}*/ ?>

<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <title><?php echo (isset($site_info['site_name']) && ($site_info['site_name'] !== '')?$site_info['site_name']:''); ?>-超级签名</title>
    <meta charset="utf-8">
...
<body data-spy="scroll" data-target="#navbar" data-offset="70">
                ...
                <div class="row">
                    <div class="navbar-header page-scroll">
                        <a class="navbar-brand page-scroll logo-light" href="#">
                            <img alt="恋plus" src="__TMPL__/public/static/image/logo5.png" >
                        </a>
                            ...
                            <div class="col-sm-6">
                                <div class="intro-text light">
                                    ...
                                    <div class="btn-holder">
                                        ...
                                        <a class="btn btn-border" href="<?php echo cmf_url('user/tube/index'); ?>" target="_blank">
                            ...
                            <div class="img-pre col-md-offset-1 col-md-5 col-sm-6">
                                <div class="slide-side text-center">
                                    ...
                                    <div class="owl-carousel nplr app-slide-auto">
                                        ...
                                        <div>
                                            <img alt="恋plus首页" src="__TMPL__/public/static/image/screen1.png" style="width: 236px">
                                        </div>
                                    </div>
                                </div>
                                <a class="btn-round video btn-round1" href="http://img001.leshangbao.com/help.mp4">
        ...
        <div class="container">
            <div class="row">
                <div class="section-text text-center">
                    ...
                    <p class="large">使用恋PLUS经常遇到的一些问题</p>
                </div>
            ...
            <div class="row">
                ...
                <ul class="social-holder text-center light">
                    <li style="margin-right: 20px;">
                        <img style="width: 120px;height: 120px;border: 1px solid #fafafa" src="__TMPL__/public/static/image/code-wechat1.png">
                        <h6 style="margin-top: 5px;font-size: 14px;">扫码添加微信</h6>
                    </li>
                    <li>
                        <img style="background-color:#fff;width: 120px;height: 120px;padding:6px;border: 1px solid #fafafa" src="__TMPL__/public/static/image/code-qq1.png">
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content" style="padding: 20px;text-align: center;">
                <p style="color: #000;font-size: 18px;font-weight: bold;">闪签微信号</p>
                <img style="border: 1px solid #f5e0e8;width: 100%;" src="__TMPL__/public/static/image/code-wechat1.png" class="img-responsive" alt="恋plus公众号">
    ...
    <div class="modal fade bs-own-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content" style="padding: 20px;text-align: center;">
                <p style="color: #000;font-size: 18px;font-weight: bold;">闪签微信号</p>
                <img style="border: 1px solid #f5e0e8;padding: 8px;" src="__TMPL__/public/static/image/code-wechat1.png" class="img-responsive" alt="恋plus公众号">
                <p style="margin-bottom: 0;margin-top: 10px;">扫码添加微信</p>
            </div>
        </div>
    </div>
