<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"themes/simpleboot3/user/profile/password.html";i:1577937062;s:35:"themes/simpleboot3/public/head.html";i:1577937062;s:35:"themes/simpleboot3/public/tube.html";i:1577956280;s:37:"themes/simpleboot3/public/footer.html";i:1577937062;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>闪签</title>
            ...
            <div class="sq-form">
                <form class="js-ajax-form" action="<?php echo url('user/Profile/passwordPost'); ?>" method="post">
                    <div class="sq-form-item">
                        <div class="item-label">原始密码：</div>
                        <div class="item-input">
                            <input name="old_password" type="password" placeholder="请输入旧密码" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="sq-form-item">
                        ...
                        <div class="item-input">
                            <input name="password" type="password" placeholder="请输入新密码" class="layui-input">
                        </div>
                    </div>

                    <div class="sq-form-item">
                        <div class="item-label">重复密码：</div>
                        <div class="item-input">
                            <input name="repassword" type="password" placeholder="请输入确认密码" class="layui-input">
                        </div>
                    </div>
