<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"themes/simpleboot3/user/register.html";i:1588177495;s:35:"themes/simpleboot3/public/head.html";i:1577937062;s:37:"themes/simpleboot3/public/footer.html";i:1577937062;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>闪签</title>
...
<body class="body-white" body onload="tip()">
    <div class="login-box">
                ...
                <form class="js-ajax-form" action="<?php echo url('user/Register/doRegister'); ?>" method="post">
                    ...
                    <div class="form-group form-group-ou">
                        <div class="phone-code" style="position: relative;">
                            <input type="text" name="code" placeholder="手机验证码" style="width:170px;" class="form-control">
...
<img src="<?php echo $__CAPTCHA_SRC; ?>" onclick="this.src='<?php echo $__CAPTCHA_SRC; ?>&time='+Math.random();" title="换一张" class="captcha captcha-img verify_img" style="cursor: pointer;"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="findpassword-right">
                            已有账号？<a href="<?php echo cmf_url('user/Login/index'); ?>">去登录</a>
                        </div>
                    </div>
