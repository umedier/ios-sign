<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_simpleboot3/admin/setting/site.html";i:1577937062;s:43:"themes/admin_simpleboot3/public/header.html";i:1577937062;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-10">
	                                ...
	                                <a href="javascript:uploadOneImage('图片上传','#thumb');">
	                                    <img src="<?php echo (isset($site_logo) && ($site_logo !== '')?$site_logo:'__TMPL__/public/assets/images/default-thumbnail.png'); ?>" id="thumb-preview"
